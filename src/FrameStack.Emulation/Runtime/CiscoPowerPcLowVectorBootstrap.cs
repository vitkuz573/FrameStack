...
public static class CiscoPowerPcLowVectorBootstrap
{
    ...
    private const uint MoveR0ToLinkRegister = 0x7C08_03A6;
    private const uint BranchToLinkRegister = 0x4E80_0020;
        ...
        uint entryPoint)
    {
        ...
        memoryBus.WriteUInt32(0x0000_0008, MoveR0ToLinkRegister);
        memoryBus.WriteUInt32(0x0000_000C, BranchToLinkRegister);
